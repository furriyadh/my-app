                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-20">
                            ...
                            <button onClick={() => router.push('/dashboard/google-ads/integrations')} className="mt-6 text-white bg-white/10 px-6 py-2 rounded-full hover:bg-white/20 transition">Back</button>
                        </div>
                    ) : (
                        <div

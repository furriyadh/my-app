...
export default function VideoSubtypePage() {
    ...
    return (
        <div className="min-h-screen overflow-x-hidden font-sans text-gray-900 dark:text-gray-100" dir="ltr">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-8 flex justify-between items-center max-w-2xl mx-auto">
                        <GlowButton onClick={() => router.push('/dashboard/google-ads/campaigns/website-url')} variant="green">

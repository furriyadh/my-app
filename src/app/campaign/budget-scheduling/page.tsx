                    ...
                    <CardItem translateZ={60} as="div" className="!w-full">
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="0"
                          dir="ltr"
                          className={`w-full pl-12 pr-4 py-4 text-3xl text-center border-2 rounded-xl focus:outline-none focus:ring-4 bg-white/20 backdrop-blur-sm text-white font-bold placeholder-white/50 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none cursor-text ${customBudgetError

    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white drop-shadow-sm flex items-center justify-center gap-3">
        ...
        {/* Main Card */}
        <div className="bg-white dark:bg-black rounded-xl shadow-2xl border-2 border-gray-300 dark:border-white p-6 max-w-3xl mx-auto mb-8">

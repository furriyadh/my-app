        ...
        <div className="relative z-[1]">
            ...
            <div className="container 2xl:max-w-[1000px] mx-auto px-4">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-base md:text-lg mb-4">
                {language === 'ar'
                  ...
                  : 'At Furriyadh L.L.C., we are committed to protecting and respecting your privacy.'}
              </p>
          ...
          <div className="container 2xl:max-w-[800px] mx-auto px-4 pb-20">
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300" dir={isRTL ? 'rtl' : 'ltr'}>
              ...
              <p>
                {language === 'ar'
                  ? 'نحن Furriyadh L.L.C.، شركة ذات مسؤولية محدودة مسجلة في أبوظبي، الإمارات العربية المتحدة (رخصة رقم CN-2843848). موقعنا الرئيسي هو:'
                  : 'We are Furriyadh L.L.C., a limited liability company incorporated in Abu Dhabi, United Arab Emirates (License No. CN-2843848). Our main website is:'}
              </p>

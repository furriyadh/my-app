                ...
                <div className="relative z-[1]">
                    ...
                    <div className="container 2xl:max-w-[800px] mx-auto px-4 pb-20">
                        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300" dir={isRTL ? 'rtl' : 'ltr'}>
                            ...
                            <p>
                                {language === 'ar'
                                    ? 'شروط الاستخدام هذه ("الشروط") هي اتفاقية ملزمة قانونياً بين شركة Furriyadh L.L.C.، وهي شركة ذات مسؤولية محدودة مسجلة في الإمارات العربية المتحدة (رقم الترخيص CN-2843848) ومقرها المسجل في شارع عين للشاحنات، أبوظبي، الإمارات العربية المتحدة، وبينك أنت المستخدم (يُشار إليك بـ "أنت" أو "العميل").'
                                    : 'These Terms of Use (the "Terms") are a legally binding agreement between Furriyadh L.L.C., a company incorporated in the United Arab Emirates (license number CN-2843848) with a registered office at Al Ain Truck Road, Abu Dhabi, United Arab Emirates, and you, the user (referred to as "You," "Your," or "Customer").'}
                            </p>
                            ...
                            <p>
                                {language === 'ar'
                                    ? 'تخضع هذه الشروط لقوانين الإمارات العربية المتحدة. سيتم حل أي نزاعات في محاكم أبوظبي، الإمارات العربية المتحدة.'

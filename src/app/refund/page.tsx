                ...
                <div className="relative z-[1]">
                    ...
                    <div className="container 2xl:max-w-[800px] mx-auto px-4 pb-20">
                        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300" dir={isRTL ? 'rtl' : 'ltr'}>
                            ...
                            <p>
                                {language === 'ar'
                                    ? 'في Furriyadh L.L.C.، نسعى لضمان رضاك عن خدماتنا. توضح هذه السياسة شروط وأحكام استرداد الأموال والإلغاء.'
                                    : 'At Furriyadh L.L.C., we strive to ensure your satisfaction with our services. This policy outlines our refund and cancellation terms and conditions.'}
                            </p>
                            ...
                            <ol className="list-decimal pl-6 space-y-2">
                                <li>{language === 'ar' ? 'تقدم Furriyadh L.L.C. ضمان استرداد الأموال لمدة 14 يوماً على جميع اشتراكات SaaS الجديدة.' : 'Furriyadh L.L.C. offers a 14-day money-back guarantee on all new SaaS subscriptions.'}</li>
                            ...
                            <ul className="list-disc pl-6">
                                ...
                                <li><strong>{language === 'ar' ? 'الشركة:' : 'Company:'}</strong> Furriyadh L.L.C. (License No. CN-2843848)</li>
                                <li><strong>{language === 'ar' ? 'العنوان:' : 'Address:'}</strong> Al Ain Truck Road, Abu Dhabi, UAE</li>
                            </ul>

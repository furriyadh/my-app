...
export default function LiveDemoSection() {
  ...
  return (
    <section id="video-demo" className="py-16 md:py-20 relative overflow-hidden bg-transparent">

      <ContainerScroll
        titleComponent={
          <>
            <div className="flex flex-col items-center justify-center mb-8 mt-8 md:mt-16">

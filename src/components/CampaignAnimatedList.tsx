...
const AnimatedItem: React.FC<AnimatedItemProps> = ({ children, delay = 0, index, onClick }) => {
...
interface CampaignAnimatedListProps {
  items?: string[];
...
const CampaignAnimatedList: React.FC<CampaignAnimatedListProps> = ({
  items = [
    'Search',
    'Display',
    'Shopping',
...
export default CampaignAnimatedList;

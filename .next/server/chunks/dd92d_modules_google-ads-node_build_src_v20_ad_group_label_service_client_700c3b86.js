...
"[project]/node_modules/google-ads-node/build/src/v20/ad_group_label_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_group_label_service_client_config.json (json)");
 ...
 */ class AdGroupLabelServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdGroupLabelService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adGroupLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdGroupLabelService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdGroupLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdGroupLabels(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdGroupLabels response %j', response);
            return [
                response,
                options,
...
exports.AdGroupLabelServiceClient = AdGroupLabelServiceClient; //# sourceMappingURL=ad_group_label_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_ad_group_label_service_client_700c3b86.js.map
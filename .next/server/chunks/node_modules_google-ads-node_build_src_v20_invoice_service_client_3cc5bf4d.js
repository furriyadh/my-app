...
"[project]/node_modules/google-ads-node/build/src/v20/invoice_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/invoice_service_client_config.json (json)");
 ...
 */ class InvoiceServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.InvoiceService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.invoiceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.InvoiceService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    listInvoices(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listInvoices(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listInvoices response %j', response);
            return [
                response,
                options,
...
exports.InvoiceServiceClient = InvoiceServiceClient; //# sourceMappingURL=invoice_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_invoice_service_client_3cc5bf4d.js.map
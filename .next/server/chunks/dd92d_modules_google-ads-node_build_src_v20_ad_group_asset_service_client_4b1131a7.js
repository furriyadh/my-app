...
"[project]/node_modules/google-ads-node/build/src/v20/ad_group_asset_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_group_asset_service_client_config.json (json)");
 ...
 */ class AdGroupAssetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdGroupAssetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adGroupAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdGroupAssetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdGroupAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdGroupAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdGroupAssets response %j', response);
            return [
                response,
                options,
...
exports.AdGroupAssetServiceClient = AdGroupAssetServiceClient; //# sourceMappingURL=ad_group_asset_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_ad_group_asset_service_client_4b1131a7.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/batch_job_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/batch_job_service_client_config.json (json)");
 ...
 */ class BatchJobServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.BatchJobService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.batchJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.BatchJobService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateBatchJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateBatchJob(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateBatchJob response %j', response);
            return [
                response,
                options,
    ...
    addBatchJobOperations(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.addBatchJobOperations(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('addBatchJobOperations response %j', response);
            return [
                response,
                options,
    ...
    runBatchJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.runBatchJob(request, options, wrappedCallback)?.then(([response, rawResponse, _])=>{
            this._log.info('runBatchJob response %j', rawResponse);
            return [
                response,
                rawResponse,
    ...
    listBatchJobResults(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listBatchJobResults(request, options, wrappedCallback)?.then(([response, input, output])=>{
...
exports.BatchJobServiceClient = BatchJobServiceClient; //# sourceMappingURL=batch_job_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_batch_job_service_client_8ebf2e4a.js.map
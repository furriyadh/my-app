...
"[project]/node_modules/google-ads-node/build/src/v20/customer_asset_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_asset_service_client_config.json (json)");
 ...
 */ class CustomerAssetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerAssetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerAssetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerAssets response %j', response);
            return [
                response,
                options,
...
exports.CustomerAssetServiceClient = CustomerAssetServiceClient; //# sourceMappingURL=customer_asset_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_customer_asset_service_client_1682ae47.js.map
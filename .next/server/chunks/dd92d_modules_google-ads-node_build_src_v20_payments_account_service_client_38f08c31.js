...
"[project]/node_modules/google-ads-node/build/src/v20/payments_account_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/payments_account_service_client_config.json (json)");
 ...
 */ class PaymentsAccountServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.PaymentsAccountService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.paymentsAccountServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.PaymentsAccountService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    listPaymentsAccounts(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listPaymentsAccounts(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listPaymentsAccounts response %j', response);
            return [
                response,
                options,
...
exports.PaymentsAccountServiceClient = PaymentsAccountServiceClient; //# sourceMappingURL=payments_account_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_payments_account_service_client_38f08c31.js.map
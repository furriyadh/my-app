...
"[project]/node_modules/google-ads-node/build/src/v20/audience_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/audience_service_client_config.json (json)");
 ...
 */ class AudienceServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AudienceService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.audienceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AudienceService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAudiences(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAudiences(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAudiences response %j', response);
            return [
                response,
                options,
...
exports.AudienceServiceClient = AudienceServiceClient; //# sourceMappingURL=audience_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_audience_service_client_6bcb7c6f.js.map
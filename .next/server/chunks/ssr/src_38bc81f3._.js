        ...
        try {
            ...
            if (error) {
                ...
                if (error.code === 'PGRST116') {
                    ...
                    const { data: newData, error: upsertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_profiles').upsert(newProfile, {
                        onConflict: 'user_id'
                    }).select().single();
                    if (upsertError) {

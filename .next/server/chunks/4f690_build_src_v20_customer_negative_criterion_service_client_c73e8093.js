...
"[project]/node_modules/google-ads-node/build/src/v20/customer_negative_criterion_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_negative_criterion_service_client_config.json (json)");
 ...
 */ class CustomerNegativeCriterionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerNegativeCriterionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerNegativeCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerNegativeCriterionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerNegativeCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerNegativeCriteria(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerNegativeCriteria response %j', response);
            return [
                response,
                options,
...
exports.CustomerNegativeCriterionServiceClient = CustomerNegativeCriterionServiceClient; //# sourceMappingURL=customer_negative_criterion_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_customer_negative_criterion_service_client_c73e8093.js.map
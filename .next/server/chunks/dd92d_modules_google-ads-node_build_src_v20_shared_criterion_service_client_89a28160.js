...
"[project]/node_modules/google-ads-node/build/src/v20/shared_criterion_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/shared_criterion_service_client_config.json (json)");
 ...
 */ class SharedCriterionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.SharedCriterionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.sharedCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.SharedCriterionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateSharedCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateSharedCriteria(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateSharedCriteria response %j', response);
            return [
                response,
                options,
...
exports.SharedCriterionServiceClient = SharedCriterionServiceClient; //# sourceMappingURL=shared_criterion_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_shared_criterion_service_client_89a28160.js.map
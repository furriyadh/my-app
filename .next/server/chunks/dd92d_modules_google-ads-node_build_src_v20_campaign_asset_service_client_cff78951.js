...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_asset_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_asset_service_client_config.json (json)");
 ...
 */ class CampaignAssetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignAssetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignAssetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignAssets response %j', response);
            return [
                response,
                options,
...
exports.CampaignAssetServiceClient = CampaignAssetServiceClient; //# sourceMappingURL=campaign_asset_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_campaign_asset_service_client_cff78951.js.map
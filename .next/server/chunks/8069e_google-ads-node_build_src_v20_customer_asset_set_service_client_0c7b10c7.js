...
"[project]/node_modules/google-ads-node/build/src/v20/customer_asset_set_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_asset_set_service_client_config.json (json)");
 ...
 */ class CustomerAssetSetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerAssetSetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerAssetSetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerAssetSets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerAssetSets response %j', response);
            return [
                response,
                options,
...
exports.CustomerAssetSetServiceClient = CustomerAssetSetServiceClient; //# sourceMappingURL=customer_asset_set_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_customer_asset_set_service_client_0c7b10c7.js.map
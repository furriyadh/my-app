...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_budget_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_budget_service_client_config.json (json)");
 ...
 */ class CampaignBudgetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignBudgetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignBudgetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignBudgetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignBudgets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignBudgets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignBudgets response %j', response);
            return [
                response,
                options,
...
exports.CampaignBudgetServiceClient = CampaignBudgetServiceClient; //# sourceMappingURL=campaign_budget_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_campaign_budget_service_client_6b5f7871.js.map
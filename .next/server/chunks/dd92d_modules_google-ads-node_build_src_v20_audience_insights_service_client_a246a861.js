...
"[project]/node_modules/google-ads-node/build/src/v20/audience_insights_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const jsonProtos = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/protos/protos.json (json)");
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/audience_insights_service_client_config.json (json)");
const version = __turbopack_context__.r("[project]/node_modules/google-ads-node/package.json (json)").version;
/**
 ...
 */ class AudienceInsightsServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AudienceInsightsService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.audienceInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AudienceInsightsService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    generateInsightsFinderReport(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateInsightsFinderReport(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateInsightsFinderReport response %j', response);
            return [
                response,
                options,
    ...
    listAudienceInsightsAttributes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listAudienceInsightsAttributes(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listAudienceInsightsAttributes response %j', response);
            return [
                response,
                options,
    ...
    listInsightsEligibleDates(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listInsightsEligibleDates(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listInsightsEligibleDates response %j', response);
            return [
                response,
                options,
    ...
    generateAudienceCompositionInsights(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateAudienceCompositionInsights(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateAudienceCompositionInsights response %j', response);
            return [
                response,
                options,
    ...
    generateSuggestedTargetingInsights(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateSuggestedTargetingInsights(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateSuggestedTargetingInsights response %j', response);
            return [
                response,
                options,
    ...
    generateAudienceOverlapInsights(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateAudienceOverlapInsights(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateAudienceOverlapInsights response %j', response);
            return [
                response,
                options,
    ...
    generateTargetingSuggestionMetrics(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateTargetingSuggestionMetrics(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateTargetingSuggestionMetrics response %j', response);
            return [
                response,
                options,
...
exports.AudienceInsightsServiceClient = AudienceInsightsServiceClient; //# sourceMappingURL=audience_insights_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_audience_insights_service_client_a246a861.js.map
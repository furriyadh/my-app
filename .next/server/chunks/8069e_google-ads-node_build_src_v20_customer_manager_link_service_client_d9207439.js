...
"[project]/node_modules/google-ads-node/build/src/v20/customer_manager_link_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_manager_link_service_client_config.json (json)");
 ...
 */ class CustomerManagerLinkServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerManagerLinkService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerManagerLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerManagerLinkService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerManagerLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerManagerLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerManagerLink response %j', response);
            return [
                response,
                options,
    ...
    moveManagerLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.moveManagerLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('moveManagerLink response %j', response);
            return [
                response,
                options,
...
exports.CustomerManagerLinkServiceClient = CustomerManagerLinkServiceClient; //# sourceMappingURL=customer_manager_link_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_customer_manager_link_service_client_d9207439.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/remarketing_action_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/remarketing_action_service_client_config.json (json)");
 ...
 */ class RemarketingActionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.RemarketingActionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.remarketingActionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.RemarketingActionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateRemarketingActions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateRemarketingActions(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateRemarketingActions response %j', response);
            return [
                response,
                options,
...
exports.RemarketingActionServiceClient = RemarketingActionServiceClient; //# sourceMappingURL=remarketing_action_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_remarketing_action_service_client_5b02484a.js.map
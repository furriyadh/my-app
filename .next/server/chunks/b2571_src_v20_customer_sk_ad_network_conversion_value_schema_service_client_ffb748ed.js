...
"[project]/node_modules/google-ads-node/build/src/v20/customer_sk_ad_network_conversion_value_schema_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_sk_ad_network_conversion_value_schema_service_client_config.json (json)");
 ...
 */ class CustomerSkAdNetworkConversionValueSchemaServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerSkAdNetworkConversionValueSchemaService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerSkAdNetworkConversionValueSchemaServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerSkAdNetworkConversionValueSchemaService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerSkAdNetworkConversionValueSchema(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerSkAdNetworkConversionValueSchema(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerSkAdNetworkConversionValueSchema response %j', response);
            return [
                response,
                options,
...
exports.CustomerSkAdNetworkConversionValueSchemaServiceClient = CustomerSkAdNetworkConversionValueSchemaServiceClient; //# sourceMappingURL=customer_sk_ad_network_conversion_value_schema_service_client.js.map
}}),

};

//# sourceMappingURL=b2571_src_v20_customer_sk_ad_network_conversion_value_schema_service_client_ffb748ed.js.map
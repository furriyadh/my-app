...
"[project]/node_modules/google-ads-node/build/src/v20/asset_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/asset_service_client_config.json (json)");
 ...
 */ class AssetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AssetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.assetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AssetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAssets response %j', response);
            return [
                response,
                options,
...
exports.AssetServiceClient = AssetServiceClient; //# sourceMappingURL=asset_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_asset_service_client_62ecc9c4.js.map
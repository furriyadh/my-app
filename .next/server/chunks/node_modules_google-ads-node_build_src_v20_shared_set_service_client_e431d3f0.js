...
"[project]/node_modules/google-ads-node/build/src/v20/shared_set_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/shared_set_service_client_config.json (json)");
 ...
 */ class SharedSetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.SharedSetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.sharedSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.SharedSetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateSharedSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateSharedSets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateSharedSets response %j', response);
            return [
                response,
                options,
...
exports.SharedSetServiceClient = SharedSetServiceClient; //# sourceMappingURL=shared_set_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_shared_set_service_client_e431d3f0.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/asset_group_asset_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/asset_group_asset_service_client_config.json (json)");
 ...
 */ class AssetGroupAssetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AssetGroupAssetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.assetGroupAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AssetGroupAssetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAssetGroupAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAssetGroupAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAssetGroupAssets response %j', response);
            return [
                response,
                options,
...
exports.AssetGroupAssetServiceClient = AssetGroupAssetServiceClient; //# sourceMappingURL=asset_group_asset_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_asset_group_asset_service_client_a0b62449.js.map
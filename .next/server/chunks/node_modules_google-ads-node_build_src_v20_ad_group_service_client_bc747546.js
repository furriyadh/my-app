...
"[project]/node_modules/google-ads-node/build/src/v20/ad_group_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_group_service_client_config.json (json)");
 ...
 */ class AdGroupServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdGroupService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdGroupService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdGroups(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdGroups response %j', response);
            return [
                response,
                options,
...
exports.AdGroupServiceClient = AdGroupServiceClient; //# sourceMappingURL=ad_group_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_ad_group_service_client_bc747546.js.map
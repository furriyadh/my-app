...
"[project]/node_modules/google-ads-node/build/src/v20/custom_interest_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/custom_interest_service_client_config.json (json)");
 ...
 */ class CustomInterestServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomInterestService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customInterestServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomInterestService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomInterests(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomInterests(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomInterests response %j', response);
            return [
                response,
                options,
...
exports.CustomInterestServiceClient = CustomInterestServiceClient; //# sourceMappingURL=custom_interest_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_custom_interest_service_client_b4a364fb.js.map
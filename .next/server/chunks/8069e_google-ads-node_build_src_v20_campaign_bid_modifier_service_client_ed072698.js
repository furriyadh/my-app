...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_bid_modifier_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_bid_modifier_service_client_config.json (json)");
 ...
 */ class CampaignBidModifierServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignBidModifierService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignBidModifierServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignBidModifierService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignBidModifiers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignBidModifiers(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignBidModifiers response %j', response);
            return [
                response,
                options,
...
exports.CampaignBidModifierServiceClient = CampaignBidModifierServiceClient; //# sourceMappingURL=campaign_bid_modifier_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_campaign_bid_modifier_service_client_ed072698.js.map
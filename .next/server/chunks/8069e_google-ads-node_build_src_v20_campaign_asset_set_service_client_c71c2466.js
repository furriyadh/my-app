...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_asset_set_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_asset_set_service_client_config.json (json)");
 ...
 */ class CampaignAssetSetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignAssetSetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignAssetSetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignAssetSets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignAssetSets response %j', response);
            return [
                response,
                options,
...
exports.CampaignAssetSetServiceClient = CampaignAssetSetServiceClient; //# sourceMappingURL=campaign_asset_set_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_campaign_asset_set_service_client_c71c2466.js.map
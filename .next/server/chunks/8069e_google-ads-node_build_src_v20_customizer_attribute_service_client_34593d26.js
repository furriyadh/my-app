...
"[project]/node_modules/google-ads-node/build/src/v20/customizer_attribute_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customizer_attribute_service_client_config.json (json)");
 ...
 */ class CustomizerAttributeServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomizerAttributeService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customizerAttributeServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomizerAttributeService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomizerAttributes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomizerAttributes(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomizerAttributes response %j', response);
            return [
                response,
                options,
...
exports.CustomizerAttributeServiceClient = CustomizerAttributeServiceClient; //# sourceMappingURL=customizer_attribute_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_customizer_attribute_service_client_34593d26.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_draft_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_draft_service_client_config.json (json)");
 ...
 */ class CampaignDraftServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignDraftService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignDraftServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignDraftService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignDrafts(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignDrafts(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignDrafts response %j', response);
            return [
                response,
                options,
    ...
    promoteCampaignDraft(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.promoteCampaignDraft(request, options, wrappedCallback)?.then(([response, rawResponse, _])=>{
            this._log.info('promoteCampaignDraft response %j', rawResponse);
            return [
                response,
                rawResponse,
    ...
    listCampaignDraftAsyncErrors(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listCampaignDraftAsyncErrors(request, options, wrappedCallback)?.then(([response, input, output])=>{
...
exports.CampaignDraftServiceClient = CampaignDraftServiceClient; //# sourceMappingURL=campaign_draft_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_campaign_draft_service_client_bc698704.js.map
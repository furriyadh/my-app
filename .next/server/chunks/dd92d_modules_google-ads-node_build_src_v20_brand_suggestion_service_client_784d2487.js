...
"[project]/node_modules/google-ads-node/build/src/v20/brand_suggestion_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/brand_suggestion_service_client_config.json (json)");
 ...
 */ class BrandSuggestionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.BrandSuggestionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.brandSuggestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.BrandSuggestionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    suggestBrands(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.suggestBrands(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('suggestBrands response %j', response);
            return [
                response,
                options,
...
exports.BrandSuggestionServiceClient = BrandSuggestionServiceClient; //# sourceMappingURL=brand_suggestion_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_brand_suggestion_service_client_784d2487.js.map
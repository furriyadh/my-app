...
"[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_ad_group_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_ad_group_service_client_config.json (json)");
 ...
 */ class KeywordPlanAdGroupServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.KeywordPlanAdGroupService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.keywordPlanAdGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.KeywordPlanAdGroupService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateKeywordPlanAdGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateKeywordPlanAdGroups(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateKeywordPlanAdGroups response %j', response);
            return [
                response,
                options,
...
exports.KeywordPlanAdGroupServiceClient = KeywordPlanAdGroupServiceClient; //# sourceMappingURL=keyword_plan_ad_group_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_keyword_plan_ad_group_service_client_aedef84a.js.map
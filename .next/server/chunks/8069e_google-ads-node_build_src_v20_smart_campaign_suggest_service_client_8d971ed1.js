...
"[project]/node_modules/google-ads-node/build/src/v20/smart_campaign_suggest_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/smart_campaign_suggest_service_client_config.json (json)");
 ...
 */ class SmartCampaignSuggestServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.SmartCampaignSuggestService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.smartCampaignSuggestServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.SmartCampaignSuggestService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    suggestSmartCampaignBudgetOptions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.suggestSmartCampaignBudgetOptions(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('suggestSmartCampaignBudgetOptions response %j', response);
            return [
                response,
                options,
    ...
    suggestSmartCampaignAd(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.suggestSmartCampaignAd(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('suggestSmartCampaignAd response %j', response);
            return [
                response,
                options,
    ...
    suggestKeywordThemes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.suggestKeywordThemes(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('suggestKeywordThemes response %j', response);
            return [
                response,
                options,
...
exports.SmartCampaignSuggestServiceClient = SmartCampaignSuggestServiceClient; //# sourceMappingURL=smart_campaign_suggest_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_smart_campaign_suggest_service_client_8d971ed1.js.map
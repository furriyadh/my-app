...
"[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_service_client_config.json (json)");
 ...
 */ class KeywordPlanServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.KeywordPlanService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.keywordPlanServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.KeywordPlanService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateKeywordPlans(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateKeywordPlans(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateKeywordPlans response %j', response);
            return [
                response,
                options,
...
exports.KeywordPlanServiceClient = KeywordPlanServiceClient; //# sourceMappingURL=keyword_plan_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_keyword_plan_service_client_caf38535.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/user_list_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/user_list_service_client_config.json (json)");
 ...
 */ class UserListServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.UserListService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.userListServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.UserListService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateUserLists(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateUserLists(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateUserLists response %j', response);
            return [
                response,
                options,
...
exports.UserListServiceClient = UserListServiceClient; //# sourceMappingURL=user_list_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_user_list_service_client_263231c4.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/customer_lifecycle_goal_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_lifecycle_goal_service_client_config.json (json)");
 ...
 */ class CustomerLifecycleGoalServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerLifecycleGoalService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerLifecycleGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerLifecycleGoalService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    configureCustomerLifecycleGoals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.configureCustomerLifecycleGoals(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('configureCustomerLifecycleGoals response %j', response);
            return [
                response,
                options,
...
exports.CustomerLifecycleGoalServiceClient = CustomerLifecycleGoalServiceClient; //# sourceMappingURL=customer_lifecycle_goal_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_customer_lifecycle_goal_service_client_983d2fa5.js.map
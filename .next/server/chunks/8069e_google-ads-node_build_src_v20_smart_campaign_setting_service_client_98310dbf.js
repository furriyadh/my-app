...
"[project]/node_modules/google-ads-node/build/src/v20/smart_campaign_setting_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/smart_campaign_setting_service_client_config.json (json)");
 ...
 */ class SmartCampaignSettingServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.SmartCampaignSettingService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.smartCampaignSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.SmartCampaignSettingService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    getSmartCampaignStatus(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.getSmartCampaignStatus(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('getSmartCampaignStatus response %j', response);
            return [
                response,
                options,
    ...
    mutateSmartCampaignSettings(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateSmartCampaignSettings(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateSmartCampaignSettings response %j', response);
            return [
                response,
                options,
...
exports.SmartCampaignSettingServiceClient = SmartCampaignSettingServiceClient; //# sourceMappingURL=smart_campaign_setting_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_smart_campaign_setting_service_client_98310dbf.js.map
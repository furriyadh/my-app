...
"[project]/node_modules/google-ads-node/build/src/v20/ad_group_criterion_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_group_criterion_service_client_config.json (json)");
 ...
 */ class AdGroupCriterionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdGroupCriterionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adGroupCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdGroupCriterionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdGroupCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdGroupCriteria(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdGroupCriteria response %j', response);
            return [
                response,
                options,
...
exports.AdGroupCriterionServiceClient = AdGroupCriterionServiceClient; //# sourceMappingURL=ad_group_criterion_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_ad_group_criterion_service_client_4e5730d8.js.map
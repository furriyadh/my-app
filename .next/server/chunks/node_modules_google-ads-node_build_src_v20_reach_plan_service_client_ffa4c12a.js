...
"[project]/node_modules/google-ads-node/build/src/v20/reach_plan_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/reach_plan_service_client_config.json (json)");
 ...
 */ class ReachPlanServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ReachPlanService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.reachPlanServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ReachPlanService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    generateConversionRates(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateConversionRates(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateConversionRates response %j', response);
            return [
                response,
                options,
    ...
    listPlannableLocations(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listPlannableLocations(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listPlannableLocations response %j', response);
            return [
                response,
                options,
    ...
    listPlannableProducts(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listPlannableProducts(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listPlannableProducts response %j', response);
            return [
                response,
                options,
    ...
    generateReachForecast(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateReachForecast(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateReachForecast response %j', response);
            return [
                response,
                options,
    ...
    listPlannableUserLists(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listPlannableUserLists(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listPlannableUserLists response %j', response);
            return [
                response,
                options,
...
exports.ReachPlanServiceClient = ReachPlanServiceClient; //# sourceMappingURL=reach_plan_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_reach_plan_service_client_ffa4c12a.js.map
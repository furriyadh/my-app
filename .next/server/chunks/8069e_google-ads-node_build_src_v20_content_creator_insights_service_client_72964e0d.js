...
"[project]/node_modules/google-ads-node/build/src/v20/content_creator_insights_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/content_creator_insights_service_client_config.json (json)");
 ...
 */ class ContentCreatorInsightsServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ContentCreatorInsightsService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.contentCreatorInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ContentCreatorInsightsService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    generateCreatorInsights(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateCreatorInsights(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateCreatorInsights response %j', response);
            return [
                response,
                options,
    ...
    generateTrendingInsights(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateTrendingInsights(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateTrendingInsights response %j', response);
            return [
                response,
                options,
...
exports.ContentCreatorInsightsServiceClient = ContentCreatorInsightsServiceClient; //# sourceMappingURL=content_creator_insights_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_content_creator_insights_service_client_72964e0d.js.map
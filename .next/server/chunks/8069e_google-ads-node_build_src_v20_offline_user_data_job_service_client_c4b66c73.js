...
"[project]/node_modules/google-ads-node/build/src/v20/offline_user_data_job_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/offline_user_data_job_service_client_config.json (json)");
 ...
 */ class OfflineUserDataJobServiceClient {
     ...
     */ constructor(opts, gaxInstance){
            ...
            lroOptions.httpRules = [
                {
                    ...
                    post: '/v20/{name=customers/*/operations/*}:cancel',
                    body: '*'
                },
                {
                ...
                },
                {
                    ...
                    post: '/v20/{name=customers/*/operations/*}:wait',
                    body: '*'
                }
            ];
        }
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.OfflineUserDataJobService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.offlineUserDataJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.OfflineUserDataJobService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    createOfflineUserDataJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.createOfflineUserDataJob(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('createOfflineUserDataJob response %j', response);
            return [
                response,
                options,
    ...
    addOfflineUserDataJobOperations(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.addOfflineUserDataJobOperations(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('addOfflineUserDataJobOperations response %j', response);
            return [
                response,
                options,
    ...
    runOfflineUserDataJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.runOfflineUserDataJob(request, options, wrappedCallback)?.then(([response, rawResponse, _])=>{
            this._log.info('runOfflineUserDataJob response %j', rawResponse);
            return [
                response,
                rawResponse,
...
exports.OfflineUserDataJobServiceClient = OfflineUserDataJobServiceClient; //# sourceMappingURL=offline_user_data_job_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_offline_user_data_job_service_client_c4b66c73.js.map
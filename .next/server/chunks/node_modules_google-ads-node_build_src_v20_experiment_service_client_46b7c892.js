...
"[project]/node_modules/google-ads-node/build/src/v20/experiment_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/experiment_service_client_config.json (json)");
 ...
 */ class ExperimentServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ExperimentService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.experimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ExperimentService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateExperiments(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateExperiments(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateExperiments response %j', response);
            return [
                response,
                options,
    ...
    endExperiment(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.endExperiment(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('endExperiment response %j', response);
            return [
                response,
                options,
    ...
    graduateExperiment(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.graduateExperiment(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('graduateExperiment response %j', response);
            return [
                response,
                options,
    ...
    scheduleExperiment(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.scheduleExperiment(request, options, wrappedCallback)?.then(([response, rawResponse, _])=>{
            this._log.info('scheduleExperiment response %j', rawResponse);
            return [
                response,
                rawResponse,
    ...
    promoteExperiment(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.promoteExperiment(request, options, wrappedCallback)?.then(([response, rawResponse, _])=>{
            this._log.info('promoteExperiment response %j', rawResponse);
            return [
                response,
                rawResponse,
    ...
    listExperimentAsyncErrors(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listExperimentAsyncErrors(request, options, wrappedCallback)?.then(([response, input, output])=>{
...
exports.ExperimentServiceClient = ExperimentServiceClient; //# sourceMappingURL=experiment_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_experiment_service_client_46b7c892.js.map
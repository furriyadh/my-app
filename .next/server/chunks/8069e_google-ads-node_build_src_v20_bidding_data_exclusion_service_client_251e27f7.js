...
"[project]/node_modules/google-ads-node/build/src/v20/bidding_data_exclusion_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/bidding_data_exclusion_service_client_config.json (json)");
 ...
 */ class BiddingDataExclusionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.BiddingDataExclusionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.biddingDataExclusionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.BiddingDataExclusionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateBiddingDataExclusions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateBiddingDataExclusions(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateBiddingDataExclusions response %j', response);
            return [
                response,
                options,
...
exports.BiddingDataExclusionServiceClient = BiddingDataExclusionServiceClient; //# sourceMappingURL=bidding_data_exclusion_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_bidding_data_exclusion_service_client_251e27f7.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/customer_customizer_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_customizer_service_client_config.json (json)");
 ...
 */ class CustomerCustomizerServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerCustomizerService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerCustomizerService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerCustomizers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerCustomizers(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerCustomizers response %j', response);
            return [
                response,
                options,
...
exports.CustomerCustomizerServiceClient = CustomerCustomizerServiceClient; //# sourceMappingURL=customer_customizer_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_customer_customizer_service_client_1a19c13c.js.map
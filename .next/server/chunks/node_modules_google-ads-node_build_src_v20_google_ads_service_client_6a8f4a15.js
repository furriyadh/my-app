...
"[project]/node_modules/google-ads-node/build/src/v20/google_ads_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/google_ads_service_client_config.json (json)");
 ...
 */ class GoogleAdsServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.GoogleAdsService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.googleAdsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.GoogleAdsService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutate(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutate(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutate response %j', response);
            return [
                response,
                options,
    ...
    search(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.search(request, options, wrappedCallback)?.then(([response, input, output])=>{
...
exports.GoogleAdsServiceClient = GoogleAdsServiceClient; //# sourceMappingURL=google_ads_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_google_ads_service_client_6a8f4a15.js.map
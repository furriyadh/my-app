...
"[project]/node_modules/google-ads-node/build/src/v20/conversion_value_rule_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/conversion_value_rule_service_client_config.json (json)");
 ...
 */ class ConversionValueRuleServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ConversionValueRuleService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.conversionValueRuleServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ConversionValueRuleService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateConversionValueRules(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateConversionValueRules(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateConversionValueRules response %j', response);
            return [
                response,
                options,
...
exports.ConversionValueRuleServiceClient = ConversionValueRuleServiceClient; //# sourceMappingURL=conversion_value_rule_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_conversion_value_rule_service_client_6360ceae.js.map
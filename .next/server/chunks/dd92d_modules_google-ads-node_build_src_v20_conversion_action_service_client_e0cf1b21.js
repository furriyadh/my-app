...
"[project]/node_modules/google-ads-node/build/src/v20/conversion_action_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/conversion_action_service_client_config.json (json)");
 ...
 */ class ConversionActionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ConversionActionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.conversionActionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ConversionActionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateConversionActions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateConversionActions(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateConversionActions response %j', response);
            return [
                response,
                options,
...
exports.ConversionActionServiceClient = ConversionActionServiceClient; //# sourceMappingURL=conversion_action_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_conversion_action_service_client_e0cf1b21.js.map
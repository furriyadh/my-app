...
"[project]/node_modules/google-ads-node/build/src/v20/account_link_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/account_link_service_client_config.json (json)");
 ...
 */ class AccountLinkServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AccountLinkService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.accountLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AccountLinkService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    createAccountLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.createAccountLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('createAccountLink response %j', response);
            return [
                response,
                options,
    ...
    mutateAccountLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAccountLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAccountLink response %j', response);
            return [
                response,
                options,
...
exports.AccountLinkServiceClient = AccountLinkServiceClient; //# sourceMappingURL=account_link_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_account_link_service_client_e3b203a5.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/customer_user_access_invitation_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_user_access_invitation_service_client_config.json (json)");
 ...
 */ class CustomerUserAccessInvitationServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerUserAccessInvitationService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerUserAccessInvitationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerUserAccessInvitationService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerUserAccessInvitation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerUserAccessInvitation(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerUserAccessInvitation response %j', response);
            return [
                response,
                options,
...
exports.CustomerUserAccessInvitationServiceClient = CustomerUserAccessInvitationServiceClient; //# sourceMappingURL=customer_user_access_invitation_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_customer_user_access_invitation_service_client_bd26e32f.js.map
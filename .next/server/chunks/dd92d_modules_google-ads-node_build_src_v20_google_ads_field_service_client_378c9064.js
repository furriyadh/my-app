...
"[project]/node_modules/google-ads-node/build/src/v20/google_ads_field_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/google_ads_field_service_client_config.json (json)");
 ...
 */ class GoogleAdsFieldServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.GoogleAdsFieldService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.googleAdsFieldServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.GoogleAdsFieldService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    getGoogleAdsField(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.getGoogleAdsField(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('getGoogleAdsField response %j', response);
            return [
                response,
                options,
    ...
    searchGoogleAdsFields(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.searchGoogleAdsFields(request, options, wrappedCallback)?.then(([response, input, output])=>{
...
exports.GoogleAdsFieldServiceClient = GoogleAdsFieldServiceClient; //# sourceMappingURL=google_ads_field_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_google_ads_field_service_client_378c9064.js.map
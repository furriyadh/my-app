...
"[project]/node_modules/google-ads-node/build/src/v20/account_budget_proposal_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/account_budget_proposal_service_client_config.json (json)");
 ...
 */ class AccountBudgetProposalServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AccountBudgetProposalService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.accountBudgetProposalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AccountBudgetProposalService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAccountBudgetProposal(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAccountBudgetProposal(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAccountBudgetProposal response %j', response);
            return [
                response,
                options,
...
exports.AccountBudgetProposalServiceClient = AccountBudgetProposalServiceClient; //# sourceMappingURL=account_budget_proposal_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_account_budget_proposal_service_client_fdc61f2d.js.map
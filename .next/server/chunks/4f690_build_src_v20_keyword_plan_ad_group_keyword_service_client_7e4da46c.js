...
"[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_ad_group_keyword_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_ad_group_keyword_service_client_config.json (json)");
 ...
 */ class KeywordPlanAdGroupKeywordServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.KeywordPlanAdGroupKeywordService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.keywordPlanAdGroupKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.KeywordPlanAdGroupKeywordService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateKeywordPlanAdGroupKeywords(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateKeywordPlanAdGroupKeywords(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateKeywordPlanAdGroupKeywords response %j', response);
            return [
                response,
                options,
...
exports.KeywordPlanAdGroupKeywordServiceClient = KeywordPlanAdGroupKeywordServiceClient; //# sourceMappingURL=keyword_plan_ad_group_keyword_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_keyword_plan_ad_group_keyword_service_client_7e4da46c.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/ad_group_customizer_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_group_customizer_service_client_config.json (json)");
 ...
 */ class AdGroupCustomizerServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdGroupCustomizerService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adGroupCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdGroupCustomizerService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdGroupCustomizers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdGroupCustomizers(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdGroupCustomizers response %j', response);
            return [
                response,
                options,
...
exports.AdGroupCustomizerServiceClient = AdGroupCustomizerServiceClient; //# sourceMappingURL=ad_group_customizer_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_ad_group_customizer_service_client_578b0f26.js.map
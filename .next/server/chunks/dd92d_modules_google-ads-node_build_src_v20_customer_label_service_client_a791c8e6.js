...
"[project]/node_modules/google-ads-node/build/src/v20/customer_label_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_label_service_client_config.json (json)");
 ...
 */ class CustomerLabelServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerLabelService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerLabelService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerLabels(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerLabels response %j', response);
            return [
                response,
                options,
...
exports.CustomerLabelServiceClient = CustomerLabelServiceClient; //# sourceMappingURL=customer_label_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_customer_label_service_client_a791c8e6.js.map
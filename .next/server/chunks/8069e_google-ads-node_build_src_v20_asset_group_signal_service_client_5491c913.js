...
"[project]/node_modules/google-ads-node/build/src/v20/asset_group_signal_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/asset_group_signal_service_client_config.json (json)");
 ...
 */ class AssetGroupSignalServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AssetGroupSignalService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.assetGroupSignalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AssetGroupSignalService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAssetGroupSignals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAssetGroupSignals(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAssetGroupSignals response %j', response);
            return [
                response,
                options,
...
exports.AssetGroupSignalServiceClient = AssetGroupSignalServiceClient; //# sourceMappingURL=asset_group_signal_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_asset_group_signal_service_client_5491c913.js.map
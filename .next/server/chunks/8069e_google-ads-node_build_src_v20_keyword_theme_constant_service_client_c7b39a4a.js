...
"[project]/node_modules/google-ads-node/build/src/v20/keyword_theme_constant_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/keyword_theme_constant_service_client_config.json (json)");
 ...
 */ class KeywordThemeConstantServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.KeywordThemeConstantService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.keywordThemeConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.KeywordThemeConstantService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    suggestKeywordThemeConstants(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.suggestKeywordThemeConstants(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('suggestKeywordThemeConstants response %j', response);
            return [
                response,
                options,
...
exports.KeywordThemeConstantServiceClient = KeywordThemeConstantServiceClient; //# sourceMappingURL=keyword_theme_constant_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_keyword_theme_constant_service_client_c7b39a4a.js.map
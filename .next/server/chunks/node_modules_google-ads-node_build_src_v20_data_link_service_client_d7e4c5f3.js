...
"[project]/node_modules/google-ads-node/build/src/v20/data_link_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/data_link_service_client_config.json (json)");
 ...
 */ class DataLinkServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.DataLinkService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.dataLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.DataLinkService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    createDataLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.createDataLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('createDataLink response %j', response);
            return [
                response,
                options,
    ...
    removeDataLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.removeDataLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('removeDataLink response %j', response);
            return [
                response,
                options,
    ...
    updateDataLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.updateDataLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('updateDataLink response %j', response);
            return [
                response,
                options,
...
exports.DataLinkServiceClient = DataLinkServiceClient; //# sourceMappingURL=data_link_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_data_link_service_client_d7e4c5f3.js.map
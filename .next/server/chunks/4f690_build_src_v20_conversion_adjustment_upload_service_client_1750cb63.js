...
"[project]/node_modules/google-ads-node/build/src/v20/conversion_adjustment_upload_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/conversion_adjustment_upload_service_client_config.json (json)");
 ...
 */ class ConversionAdjustmentUploadServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ConversionAdjustmentUploadService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.conversionAdjustmentUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ConversionAdjustmentUploadService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    uploadConversionAdjustments(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.uploadConversionAdjustments(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('uploadConversionAdjustments response %j', response);
            return [
                response,
                options,
...
exports.ConversionAdjustmentUploadServiceClient = ConversionAdjustmentUploadServiceClient; //# sourceMappingURL=conversion_adjustment_upload_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_conversion_adjustment_upload_service_client_1750cb63.js.map
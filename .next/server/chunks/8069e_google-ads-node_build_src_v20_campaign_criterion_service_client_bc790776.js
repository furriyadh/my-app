...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_criterion_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_criterion_service_client_config.json (json)");
 ...
 */ class CampaignCriterionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignCriterionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignCriterionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignCriteria(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignCriteria response %j', response);
            return [
                response,
                options,
...
exports.CampaignCriterionServiceClient = CampaignCriterionServiceClient; //# sourceMappingURL=campaign_criterion_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_campaign_criterion_service_client_bc790776.js.map
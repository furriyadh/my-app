...
"[project]/node_modules/google-ads-node/build/src/v20/local_services_lead_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/local_services_lead_service_client_config.json (json)");
 ...
 */ class LocalServicesLeadServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.LocalServicesLeadService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.localServicesLeadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.LocalServicesLeadService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    appendLeadConversation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.appendLeadConversation(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('appendLeadConversation response %j', response);
            return [
                response,
                options,
    ...
    provideLeadFeedback(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.provideLeadFeedback(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('provideLeadFeedback response %j', response);
            return [
                response,
                options,
...
exports.LocalServicesLeadServiceClient = LocalServicesLeadServiceClient; //# sourceMappingURL=local_services_lead_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_local_services_lead_service_client_1dfb7208.js.map
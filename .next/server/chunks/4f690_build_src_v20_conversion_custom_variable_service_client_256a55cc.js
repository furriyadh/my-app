...
"[project]/node_modules/google-ads-node/build/src/v20/conversion_custom_variable_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/conversion_custom_variable_service_client_config.json (json)");
 ...
 */ class ConversionCustomVariableServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ConversionCustomVariableService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.conversionCustomVariableServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ConversionCustomVariableService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateConversionCustomVariables(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateConversionCustomVariables(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateConversionCustomVariables response %j', response);
            return [
                response,
                options,
...
exports.ConversionCustomVariableServiceClient = ConversionCustomVariableServiceClient; //# sourceMappingURL=conversion_custom_variable_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_conversion_custom_variable_service_client_256a55cc.js.map
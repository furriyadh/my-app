...
"[project]/node_modules/google-ads-node/build/src/v20/asset_set_asset_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/asset_set_asset_service_client_config.json (json)");
 ...
 */ class AssetSetAssetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AssetSetAssetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.assetSetAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AssetSetAssetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAssetSetAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAssetSetAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAssetSetAssets response %j', response);
            return [
                response,
                options,
...
exports.AssetSetAssetServiceClient = AssetSetAssetServiceClient; //# sourceMappingURL=asset_set_asset_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_asset_set_asset_service_client_6c138d3a.js.map
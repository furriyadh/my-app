...
"[project]/node_modules/google-ads-node/build/src/v20/user_data_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/user_data_service_client_config.json (json)");
 ...
 */ class UserDataServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.UserDataService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.userDataServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.UserDataService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    uploadUserData(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.uploadUserData(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('uploadUserData response %j', response);
            return [
                response,
                options,
...
exports.UserDataServiceClient = UserDataServiceClient; //# sourceMappingURL=user_data_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_user_data_service_client_b3ef0ed3.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/recommendation_subscription_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/recommendation_subscription_service_client_config.json (json)");
 ...
 */ class RecommendationSubscriptionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.RecommendationSubscriptionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.recommendationSubscriptionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.RecommendationSubscriptionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateRecommendationSubscription(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateRecommendationSubscription(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateRecommendationSubscription response %j', response);
            return [
                response,
                options,
...
exports.RecommendationSubscriptionServiceClient = RecommendationSubscriptionServiceClient; //# sourceMappingURL=recommendation_subscription_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_recommendation_subscription_service_client_e7e5c8c2.js.map
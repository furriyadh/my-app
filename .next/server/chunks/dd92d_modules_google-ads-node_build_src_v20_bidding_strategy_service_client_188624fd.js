...
"[project]/node_modules/google-ads-node/build/src/v20/bidding_strategy_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/bidding_strategy_service_client_config.json (json)");
 ...
 */ class BiddingStrategyServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.BiddingStrategyService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.biddingStrategyServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.BiddingStrategyService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateBiddingStrategies(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateBiddingStrategies(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateBiddingStrategies response %j', response);
            return [
                response,
                options,
...
exports.BiddingStrategyServiceClient = BiddingStrategyServiceClient; //# sourceMappingURL=bidding_strategy_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_bidding_strategy_service_client_188624fd.js.map
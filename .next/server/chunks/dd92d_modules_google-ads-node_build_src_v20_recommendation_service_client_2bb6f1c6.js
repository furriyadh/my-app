...
"[project]/node_modules/google-ads-node/build/src/v20/recommendation_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/recommendation_service_client_config.json (json)");
 ...
 */ class RecommendationServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.RecommendationService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.recommendationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.RecommendationService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    applyRecommendation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.applyRecommendation(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('applyRecommendation response %j', response);
            return [
                response,
                options,
    ...
    dismissRecommendation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.dismissRecommendation(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('dismissRecommendation response %j', response);
            return [
                response,
                options,
    ...
    generateRecommendations(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateRecommendations(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateRecommendations response %j', response);
            return [
                response,
                options,
...
exports.RecommendationServiceClient = RecommendationServiceClient; //# sourceMappingURL=recommendation_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_recommendation_service_client_2bb6f1c6.js.map
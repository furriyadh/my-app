...
"[project]/node_modules/google-ads-node/build/src/v20/billing_setup_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/billing_setup_service_client_config.json (json)");
 ...
 */ class BillingSetupServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.BillingSetupService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.billingSetupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.BillingSetupService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateBillingSetup(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateBillingSetup(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateBillingSetup response %j', response);
            return [
                response,
                options,
...
exports.BillingSetupServiceClient = BillingSetupServiceClient; //# sourceMappingURL=billing_setup_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_billing_setup_service_client_e4abcb78.js.map
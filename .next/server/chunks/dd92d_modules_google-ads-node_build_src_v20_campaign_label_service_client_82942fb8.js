...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_label_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_label_service_client_config.json (json)");
 ...
 */ class CampaignLabelServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignLabelService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignLabelService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignLabels(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignLabels response %j', response);
            return [
                response,
                options,
...
exports.CampaignLabelServiceClient = CampaignLabelServiceClient; //# sourceMappingURL=campaign_label_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_campaign_label_service_client_82942fb8.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/ad_group_asset_set_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_group_asset_set_service_client_config.json (json)");
 ...
 */ class AdGroupAssetSetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdGroupAssetSetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adGroupAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdGroupAssetSetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdGroupAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdGroupAssetSets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdGroupAssetSets response %j', response);
            return [
                response,
                options,
...
exports.AdGroupAssetSetServiceClient = AdGroupAssetSetServiceClient; //# sourceMappingURL=ad_group_asset_set_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_ad_group_asset_set_service_client_d2b76322.js.map
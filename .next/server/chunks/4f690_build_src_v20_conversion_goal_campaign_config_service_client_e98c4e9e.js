...
"[project]/node_modules/google-ads-node/build/src/v20/conversion_goal_campaign_config_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/conversion_goal_campaign_config_service_client_config.json (json)");
 ...
 */ class ConversionGoalCampaignConfigServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ConversionGoalCampaignConfigService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.conversionGoalCampaignConfigServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ConversionGoalCampaignConfigService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateConversionGoalCampaignConfigs(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateConversionGoalCampaignConfigs(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateConversionGoalCampaignConfigs response %j', response);
            return [
                response,
                options,
...
exports.ConversionGoalCampaignConfigServiceClient = ConversionGoalCampaignConfigServiceClient; //# sourceMappingURL=conversion_goal_campaign_config_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_conversion_goal_campaign_config_service_client_e98c4e9e.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/third_party_app_analytics_link_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/third_party_app_analytics_link_service_client_config.json (json)");
 ...
 */ class ThirdPartyAppAnalyticsLinkServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ThirdPartyAppAnalyticsLinkService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.thirdPartyAppAnalyticsLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ThirdPartyAppAnalyticsLinkService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    regenerateShareableLinkId(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.regenerateShareableLinkId(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('regenerateShareableLinkId response %j', response);
            return [
                response,
                options,
...
exports.ThirdPartyAppAnalyticsLinkServiceClient = ThirdPartyAppAnalyticsLinkServiceClient; //# sourceMappingURL=third_party_app_analytics_link_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_third_party_app_analytics_link_service_client_7bb4e01c.js.map
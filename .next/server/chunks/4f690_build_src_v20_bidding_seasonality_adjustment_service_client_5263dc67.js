...
"[project]/node_modules/google-ads-node/build/src/v20/bidding_seasonality_adjustment_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/bidding_seasonality_adjustment_service_client_config.json (json)");
 ...
 */ class BiddingSeasonalityAdjustmentServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.biddingSeasonalityAdjustmentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateBiddingSeasonalityAdjustments(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateBiddingSeasonalityAdjustments(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateBiddingSeasonalityAdjustments response %j', response);
            return [
                response,
                options,
...
exports.BiddingSeasonalityAdjustmentServiceClient = BiddingSeasonalityAdjustmentServiceClient; //# sourceMappingURL=bidding_seasonality_adjustment_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_bidding_seasonality_adjustment_service_client_5263dc67.js.map
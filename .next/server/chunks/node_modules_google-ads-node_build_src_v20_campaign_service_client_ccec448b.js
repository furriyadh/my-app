...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_service_client_config.json (json)");
 ...
 */ class CampaignServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaigns(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaigns(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaigns response %j', response);
            return [
                response,
                options,
    ...
    enablePMaxBrandGuidelines(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.enablePMaxBrandGuidelines(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('enablePMaxBrandGuidelines response %j', response);
            return [
                response,
                options,
...
exports.CampaignServiceClient = CampaignServiceClient; //# sourceMappingURL=campaign_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_campaign_service_client_ccec448b.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/label_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/label_service_client_config.json (json)");
 ...
 */ class LabelServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.LabelService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.labelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.LabelService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateLabels(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateLabels response %j', response);
            return [
                response,
                options,
...
exports.LabelServiceClient = LabelServiceClient; //# sourceMappingURL=label_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_label_service_client_59cbf558.js.map
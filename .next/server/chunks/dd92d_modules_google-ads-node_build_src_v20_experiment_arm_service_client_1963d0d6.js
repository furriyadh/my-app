...
"[project]/node_modules/google-ads-node/build/src/v20/experiment_arm_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/experiment_arm_service_client_config.json (json)");
 ...
 */ class ExperimentArmServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ExperimentArmService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.experimentArmServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ExperimentArmService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateExperimentArms(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateExperimentArms(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateExperimentArms response %j', response);
            return [
                response,
                options,
...
exports.ExperimentArmServiceClient = ExperimentArmServiceClient; //# sourceMappingURL=experiment_arm_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_experiment_arm_service_client_1963d0d6.js.map
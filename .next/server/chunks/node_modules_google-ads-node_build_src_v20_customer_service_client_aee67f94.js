...
"[project]/node_modules/google-ads-node/build/src/v20/customer_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_service_client_config.json (json)");
 ...
 */ class CustomerServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomer(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomer(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomer response %j', response);
            return [
                response,
                options,
    ...
    listAccessibleCustomers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.listAccessibleCustomers(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('listAccessibleCustomers response %j', response);
            return [
                response,
                options,
    ...
    createCustomerClient(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.createCustomerClient(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('createCustomerClient response %j', response);
            return [
                response,
                options,
...
exports.CustomerServiceClient = CustomerServiceClient; //# sourceMappingURL=customer_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_customer_service_client_aee67f94.js.map
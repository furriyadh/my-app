...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_customizer_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_customizer_service_client_config.json (json)");
 ...
 */ class CampaignCustomizerServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignCustomizerService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignCustomizerService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignCustomizers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignCustomizers(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignCustomizers response %j', response);
            return [
                response,
                options,
...
exports.CampaignCustomizerServiceClient = CampaignCustomizerServiceClient; //# sourceMappingURL=campaign_customizer_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_campaign_customizer_service_client_098ea5be.js.map
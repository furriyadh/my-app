...
"[project]/node_modules/google-ads-node/build/src/v20/customer_conversion_goal_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_conversion_goal_service_client_config.json (json)");
 ...
 */ class CustomerConversionGoalServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerConversionGoalService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerConversionGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerConversionGoalService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerConversionGoals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerConversionGoals(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerConversionGoals response %j', response);
            return [
                response,
                options,
...
exports.CustomerConversionGoalServiceClient = CustomerConversionGoalServiceClient; //# sourceMappingURL=customer_conversion_goal_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_customer_conversion_goal_service_client_5cc6464f.js.map
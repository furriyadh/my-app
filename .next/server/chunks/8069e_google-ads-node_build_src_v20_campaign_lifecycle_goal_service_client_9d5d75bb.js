...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_lifecycle_goal_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_lifecycle_goal_service_client_config.json (json)");
 ...
 */ class CampaignLifecycleGoalServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignLifecycleGoalService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignLifecycleGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignLifecycleGoalService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    configureCampaignLifecycleGoals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.configureCampaignLifecycleGoals(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('configureCampaignLifecycleGoals response %j', response);
            return [
                response,
                options,
...
exports.CampaignLifecycleGoalServiceClient = CampaignLifecycleGoalServiceClient; //# sourceMappingURL=campaign_lifecycle_goal_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_campaign_lifecycle_goal_service_client_9d5d75bb.js.map
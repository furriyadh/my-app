...
"[project]/node_modules/google-ads-node/build/src/v20/product_link_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/product_link_service_client_config.json (json)");
 ...
 */ class ProductLinkServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ProductLinkService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.productLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ProductLinkService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    createProductLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.createProductLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('createProductLink response %j', response);
            return [
                response,
                options,
    ...
    removeProductLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.removeProductLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('removeProductLink response %j', response);
            return [
                response,
                options,
...
exports.ProductLinkServiceClient = ProductLinkServiceClient; //# sourceMappingURL=product_link_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_product_link_service_client_0e88b20f.js.map
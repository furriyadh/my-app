...
"[project]/node_modules/google-ads-node/build/src/v20/conversion_upload_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/conversion_upload_service_client_config.json (json)");
 ...
 */ class ConversionUploadServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ConversionUploadService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.conversionUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ConversionUploadService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    uploadClickConversions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.uploadClickConversions(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('uploadClickConversions response %j', response);
            return [
                response,
                options,
    ...
    uploadCallConversions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.uploadCallConversions(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('uploadCallConversions response %j', response);
            return [
                response,
                options,
...
exports.ConversionUploadServiceClient = ConversionUploadServiceClient; //# sourceMappingURL=conversion_upload_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_conversion_upload_service_client_0714a431.js.map
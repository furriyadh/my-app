...
"[project]/node_modules/google-ads-node/build/src/v20/ad_parameter_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_parameter_service_client_config.json (json)");
 ...
 */ class AdParameterServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdParameterService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adParameterServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdParameterService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdParameters(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdParameters(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdParameters response %j', response);
            return [
                response,
                options,
...
exports.AdParameterServiceClient = AdParameterServiceClient; //# sourceMappingURL=ad_parameter_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_ad_parameter_service_client_88404336.js.map
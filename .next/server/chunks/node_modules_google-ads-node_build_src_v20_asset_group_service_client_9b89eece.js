...
"[project]/node_modules/google-ads-node/build/src/v20/asset_group_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/asset_group_service_client_config.json (json)");
 ...
 */ class AssetGroupServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AssetGroupService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.assetGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AssetGroupService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAssetGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAssetGroups(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAssetGroups response %j', response);
            return [
                response,
                options,
...
exports.AssetGroupServiceClient = AssetGroupServiceClient; //# sourceMappingURL=asset_group_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_asset_group_service_client_9b89eece.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_idea_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_idea_service_client_config.json (json)");
 ...
 */ class KeywordPlanIdeaServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.KeywordPlanIdeaService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.keywordPlanIdeaServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.KeywordPlanIdeaService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    generateKeywordHistoricalMetrics(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateKeywordHistoricalMetrics(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateKeywordHistoricalMetrics response %j', response);
            return [
                response,
                options,
    ...
    generateAdGroupThemes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateAdGroupThemes(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateAdGroupThemes response %j', response);
            return [
                response,
                options,
    ...
    generateKeywordForecastMetrics(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateKeywordForecastMetrics(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('generateKeywordForecastMetrics response %j', response);
            return [
                response,
                options,
    ...
    generateKeywordIdeas(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.generateKeywordIdeas(request, options, wrappedCallback)?.then(([response, input, output])=>{
...
exports.KeywordPlanIdeaServiceClient = KeywordPlanIdeaServiceClient; //# sourceMappingURL=keyword_plan_idea_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_keyword_plan_idea_service_client_636b091b.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/ad_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_service_client_config.json (json)");
 ...
 */ class AdServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAds(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAds(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAds response %j', response);
            return [
                response,
                options,
...
exports.AdServiceClient = AdServiceClient; //# sourceMappingURL=ad_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_ad_service_client_fd56a4b3.js.map
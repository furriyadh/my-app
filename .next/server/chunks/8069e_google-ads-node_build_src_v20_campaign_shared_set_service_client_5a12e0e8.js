...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_shared_set_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_shared_set_service_client_config.json (json)");
 ...
 */ class CampaignSharedSetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignSharedSetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignSharedSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignSharedSetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignSharedSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignSharedSets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignSharedSets response %j', response);
            return [
                response,
                options,
...
exports.CampaignSharedSetServiceClient = CampaignSharedSetServiceClient; //# sourceMappingURL=campaign_shared_set_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_campaign_shared_set_service_client_5a12e0e8.js.map
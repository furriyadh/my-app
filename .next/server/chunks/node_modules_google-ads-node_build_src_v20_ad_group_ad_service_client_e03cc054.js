...
"[project]/node_modules/google-ads-node/build/src/v20/ad_group_ad_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/ad_group_ad_service_client_config.json (json)");
 ...
 */ class AdGroupAdServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AdGroupAdService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.adGroupAdServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AdGroupAdService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAdGroupAds(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAdGroupAds(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAdGroupAds response %j', response);
            return [
                response,
                options,
    ...
    removeAutomaticallyCreatedAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.removeAutomaticallyCreatedAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('removeAutomaticallyCreatedAssets response %j', response);
            return [
                response,
                options,
...
exports.AdGroupAdServiceClient = AdGroupAdServiceClient; //# sourceMappingURL=ad_group_ad_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_ad_group_ad_service_client_e03cc054.js.map
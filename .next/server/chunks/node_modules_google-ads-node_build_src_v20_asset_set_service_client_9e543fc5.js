...
"[project]/node_modules/google-ads-node/build/src/v20/asset_set_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/asset_set_service_client_config.json (json)");
 ...
 */ class AssetSetServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.AssetSetService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.assetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.AssetSetService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateAssetSets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateAssetSets response %j', response);
            return [
                response,
                options,
...
exports.AssetSetServiceClient = AssetSetServiceClient; //# sourceMappingURL=asset_set_service_client.js.map
}}),

};

//# sourceMappingURL=node_modules_google-ads-node_build_src_v20_asset_set_service_client_9e543fc5.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_campaign_keyword_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/keyword_plan_campaign_keyword_service_client_config.json (json)");
 ...
 */ class KeywordPlanCampaignKeywordServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.KeywordPlanCampaignKeywordService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.keywordPlanCampaignKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.KeywordPlanCampaignKeywordService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateKeywordPlanCampaignKeywords(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateKeywordPlanCampaignKeywords(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateKeywordPlanCampaignKeywords response %j', response);
            return [
                response,
                options,
...
exports.KeywordPlanCampaignKeywordServiceClient = KeywordPlanCampaignKeywordServiceClient; //# sourceMappingURL=keyword_plan_campaign_keyword_service_client.js.map
}}),

};

//# sourceMappingURL=4f690_build_src_v20_keyword_plan_campaign_keyword_service_client_ca3a1986.js.map
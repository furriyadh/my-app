...
"[project]/node_modules/google-ads-node/build/src/v20/customer_client_link_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/customer_client_link_service_client_config.json (json)");
 ...
 */ class CustomerClientLinkServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomerClientLinkService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customerClientLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomerClientLinkService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomerClientLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomerClientLink(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomerClientLink response %j', response);
            return [
                response,
                options,
...
exports.CustomerClientLinkServiceClient = CustomerClientLinkServiceClient; //# sourceMappingURL=customer_client_link_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_customer_client_link_service_client_2e375069.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/product_link_invitation_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/product_link_invitation_service_client_config.json (json)");
 ...
 */ class ProductLinkInvitationServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.ProductLinkInvitationService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.productLinkInvitationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.ProductLinkInvitationService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    createProductLinkInvitation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.createProductLinkInvitation(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('createProductLinkInvitation response %j', response);
            return [
                response,
                options,
    ...
    updateProductLinkInvitation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.updateProductLinkInvitation(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('updateProductLinkInvitation response %j', response);
            return [
                response,
                options,
    ...
    removeProductLinkInvitation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.removeProductLinkInvitation(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('removeProductLinkInvitation response %j', response);
            return [
                response,
                options,
...
exports.ProductLinkInvitationServiceClient = ProductLinkInvitationServiceClient; //# sourceMappingURL=product_link_invitation_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_product_link_invitation_service_client_58f63871.js.map
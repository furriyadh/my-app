...
"[project]/node_modules/google-ads-node/build/src/v20/travel_asset_suggestion_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/travel_asset_suggestion_service_client_config.json (json)");
 ...
 */ class TravelAssetSuggestionServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.TravelAssetSuggestionService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.travelAssetSuggestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.TravelAssetSuggestionService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    suggestTravelAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.suggestTravelAssets(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('suggestTravelAssets response %j', response);
            return [
                response,
                options,
...
exports.TravelAssetSuggestionServiceClient = TravelAssetSuggestionServiceClient; //# sourceMappingURL=travel_asset_suggestion_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_travel_asset_suggestion_service_client_716be325.js.map
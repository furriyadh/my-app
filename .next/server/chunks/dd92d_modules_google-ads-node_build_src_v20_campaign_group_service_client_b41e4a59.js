...
"[project]/node_modules/google-ads-node/build/src/v20/campaign_group_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/campaign_group_service_client_config.json (json)");
 ...
 */ class CampaignGroupServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CampaignGroupService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.campaignGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CampaignGroupService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCampaignGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCampaignGroups(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCampaignGroups response %j', response);
            return [
                response,
                options,
...
exports.CampaignGroupServiceClient = CampaignGroupServiceClient; //# sourceMappingURL=campaign_group_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_campaign_group_service_client_b41e4a59.js.map
...
"[project]/node_modules/google-ads-node/build/src/v20/identity_verification_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/identity_verification_service_client_config.json (json)");
 ...
 */ class IdentityVerificationServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.IdentityVerificationService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.identityVerificationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.IdentityVerificationService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    startIdentityVerification(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.startIdentityVerification(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('startIdentityVerification response %j', response);
            return [
                response,
                options,
    ...
    getIdentityVerification(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.getIdentityVerification(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('getIdentityVerification response %j', response);
            return [
                response,
                options,
...
exports.IdentityVerificationServiceClient = IdentityVerificationServiceClient; //# sourceMappingURL=identity_verification_service_client.js.map
}}),

};

//# sourceMappingURL=8069e_google-ads-node_build_src_v20_identity_verification_service_client_6db37bd3.js.map
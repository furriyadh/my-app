...
"[project]/node_modules/google-ads-node/build/src/v20/custom_audience_service_client.js [app-route] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const gapicConfig = __turbopack_context__.r("[project]/node_modules/google-ads-node/build/src/v20/custom_audience_service_client_config.json (json)");
 ...
 */ class CustomAudienceServiceClient {
     ...
     */ constructor(opts, gaxInstance){
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v20.services.CustomAudienceService', gapicConfig, opts.clientConfig || {}, {
     ...
     */ initialize() {
        ...
        this.customAudienceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.ads.googleads.v20.services.CustomAudienceService') : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    mutateCustomAudiences(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.mutateCustomAudiences(request, options, wrappedCallback)?.then(([response, options, rawResponse])=>{
            this._log.info('mutateCustomAudiences response %j', response);
            return [
                response,
                options,
...
exports.CustomAudienceServiceClient = CustomAudienceServiceClient; //# sourceMappingURL=custom_audience_service_client.js.map
}}),

};

//# sourceMappingURL=dd92d_modules_google-ads-node_build_src_v20_custom_audience_service_client_1612c674.js.map
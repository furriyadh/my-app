...
const AccountSettingsForm = ()=>{
    ...
    const handleSaveChanges = async ()=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserService"].updateUserProfile(dataToSave);
            if (result.error) {
                setError(result.error);
            } else {
...
_s(AccountSettingsForm, "xXIgMST4QsxCLhPS3z8cwHwX1oM=");
...
//# sourceMappingURL=src_bb898670._.js.map
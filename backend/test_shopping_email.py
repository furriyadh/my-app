"""Test email sending for SHOPPING Campaign"""
import os
import sys
...
# Test SHOPPING Campaign Data
test_data = {
    'campaign_name': 'E-commerce Winter Collection',
    'campaign_type': 'SHOPPING',
    'daily_budget': 75,
    'currency': 'USD',
    'customer_id': '904-840-9219',
    'website_url': 'https://furriyadh.com/shop',
    'manual_upload': False
}

# Send test email
target_email = 'hossam675r4e3@gmail.com'
print(f'📤 Sending SHOPPING campaign test email to {target_email}...')
